...
def load_entry():
    ...
    package.__path__ = [str(ROOT / "addin/EVE")]
    ...
    fake_tools = ModuleType("clipboard_test_addin.eve.fusion_tools")
    fake_tools.FusionTools = object
    modules = {"clipboard_test_addin": package, "adsk": adsk, "adsk.core": core,
               "clipboard_test_addin.eve.fusion_tools": fake_tools}
    with patch.dict(sys.modules, modules):
        spec = importlib.util.spec_from_file_location("clipboard_test_addin.EVE", ROOT / "addin/EVE/EVE.py")
