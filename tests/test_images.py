...
from eve.images import ImageStore, validate_images, MAX_IMAGE_BYTES, MAX_STORED_IMAGE_BYTES
from eve.controller import Controller, conversation_messages, message_input, VIEWPORT_PREFIX, SAVED_IMAGE_PREFIX
from eve.tool_protocol import validate_call
...
class ImageControllerTests(unittest.TestCase):
    ...
    def test_list_and_view_reinject_pixels_only_on_request_without_fusion_calls(self):
        ...
        eventually(lambda: self.controller.images.list_chat("thread-1")["total"] == 1)
