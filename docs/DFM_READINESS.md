...
| #27 Sheet metal/RMFG | Native rule and existing flat-pattern metadata; single-body STEP export; optional OAuth, protected storage, upload approval, immutable retry jobs and scoped reports | Formed/bent-part geometry fixtures; real account authorization and approved supplier upload/report with an actionable finding; live macOS export |
...
paired pocket repair (#39), reference discovery (#40), and the applicability/readiness
changes accompanying this document. Later branches include
